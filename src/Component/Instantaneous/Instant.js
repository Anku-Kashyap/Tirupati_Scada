...
function Instant() {
  ...
  const stationsByDivision = {
    ...
    ZONE2: ["ZONE2_NHAI_ROAD", "ZONE2_MOKSHDHAM"],
    ZONE3: ["ZONE3_POLICE_STATION", "ZONE3_DREAM_CITY"],
  };
  ...
  const ZONE1_S2 = useAPi(Base_Url + "tpzone1/102");
  const ZONE2_S1 = useAPi(Base_Url + "tpzone2/101");
  const ZONE2_S2 = useAPi(Base_Url + "tpzone2/102");
  const ZONE3_S1 = useAPi(Base_Url + "tpzone3/101");
  const ZONE3_S2 = useAPi(Base_Url + "tpzone3/102");
  ...
  const CheckChange = () => {
    switch (true) {
      case division === "ZONE1" && station === "ZONE1_TW_IN_BLOCK":
      ...
      //KAHRAKMAFF
      case division === "ZONE1" && station === "ZONE1_DEEP_PUBLIC_SCHOOL":
        ZONE1_S2.getReq();
      ...
      case division === "ZONE3" && station === "ZONE3_DREAM_CITY":
        ZONE3_S2.getReq();
